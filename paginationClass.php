...
class Pagination{
    ...
    function createLinks(){
        ...
        if ($numPages == 1){
            if ($this->showCount){
                $info = 'Showing : ' . $this->totalRows." Result(s)";
                $out = "<nav style=\"color:#3498DB; margin-left: auto\" aria-label=\"pagination example\">
<ul class=\"pagination pagination-circle pg-blue mb-0\">
<li style=\"color: #3498DB;\" class=\"page-item\"><a class=\"page-link\">$info</a></li>
</ul>
</nav>";
                return $out;
            }else{
        ...
        if ($this->showCount){
            ...
            $output .= "<nav style=\"color:white;\" aria-label=\"pagination example\">
<ul class=\"pagination pagination-circle pg-blue mb-0\">
<li style=\"color:white;\" class=\"page-item\"><a class=\"page-link\">$info</a></li>
</ul>
</nav>";
        }
    ...
    function getAJAXlink( $count, $text) {
        ...
        return "<a style=\"text-align: center\" href=\"#\" " . $this->anchorClass . "
                ". $linkClick .">". $text .'</a>';
